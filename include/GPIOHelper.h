...
public:
	...
	static volatile gpio_t* InitPin_Out(void *base, int pagemask, int memaddress, int bit);
	static volatile gpio_t* InitPin_In(void *base, int pagemask, int memaddress, int bit);
